...
class PracticalInformation extends React.Component {
  ...
  render() {
    ...
    let module = this.props.event.modules.filter(function (module, i) {
      return in_array(module.alias, ["infobooth"]);
    });
                ...
                <React.Fragment>
                  <div style={{height: '100%'}}>
                    <div style={{margin: '0'}} className="new-header clearfix">
                      <div className="row">
                        <div className="col-6">
                          <h1 className="section-title">{(module[0]['value'] !== undefined ? module[0]['value'] : t('PI_NAME'))}</h1>
                          <p>{t('PI_SUB_HEADING')} </p>
                        </div>
                        <div className="col-6">
                                  ...
                                  >
                                            ...
                                            {item.type === 'folder' && (
                                              <div className="wrapp_add_button">
                                                <span onClick={this.handleDropdown.bind(this)}
                                                  className="btn_addmore"><i className="icons"><Img src={require("img/ico-dots.svg")} /></i></span>
                                                <div className="drop_down_panel">
                                                  <button
                                                    onClick={this.handleshowInner('folder', item.id, item.id)}
                                                    className="btn"><i className="icons"><Img
                                                      src={require("img/ico-addfolder-lg.svg")} /></i>{t('PI_ADD_FOLDER')}
                                                  </button>
                                                  <button
                                                    onClick={this.handleshowInner('link', item.id, item.id)}
                                                    className="btn"><i className="icons"><Img
                                                      src={require("img/ico-addlink-lg.svg")} /></i>{t('PI_ADD_LINK')}
                                                  </button>
                                                  <button
                                                    onClick={this.handleshowInner('page', item.id, item.id)}
                                                    className="btn"><i className="icons"><Img
                                                      src={require("img/ico-addpage-lg.svg")} /></i>{t('PI_ADD_PAGE')}
                                                  </button>
                                                </div>
                                              </div>
                                            )}
                                    ...
                                    {this.state.link && this.state.displayInner === item.id && (
                                      <div className="parctical-info-widgets">
                                        <Link
                                          datamode={this.state.childEditMode ? t('PI_EDIT_LINK') : t('PI_ADD_LINK')}
