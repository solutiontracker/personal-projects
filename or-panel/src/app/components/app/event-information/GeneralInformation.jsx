...
class GeneralInformation extends React.Component {
  ...
  componentDidMount() {
    ...
    if (this.props.event.modules !== undefined && this.props.event.modules.length > 0) {
      ...
      let index = modules.findIndex(function (module, i) {
        return module.alias === "general_info";
      });
  ...
  render() {
    ...
    let module = this.props.event.modules.filter(function (module, i) {
      return in_array(module.alias, ["general_info"]);
    });
                ...
                <React.Fragment>
                  <div style={{ height: '100%' }}>
                    <div style={{ margin: '0' }} className="new-header clearfix">
                      <div className="row">
                        <div className="col-6">
                          <h1 className="section-title">{(module[0]['value'] !== undefined ? module[0]['value'] : t('GI_NAME'))}</h1>
                          <p>{t('GI_SUB_HEADING')} </p>
                        </div>
                        <div className="col-6">
                                  ...
                                  >
                                              ...
                                              <div className="drop_down_panel">
                                                <button
                                                  ...
                                                  className="btn"><i className="icons"><Img
                                                    src={require("img/ico-addfolder-lg.svg")} /></i>{t('GI_ADD_FOLDER')}
                                                </button>
                                                <button
                                                  onClick={this.handleshowInner('link', item.id, item.id)}
                                                  className="btn"><i className="icons"><Img
                                                    src={require("img/ico-addlink-lg.svg")} /></i>{t('GI_ADD_LINK')}
                                                </button>
                                                <button
                                                  onClick={this.handleshowInner('page', item.id, item.id)}
                                                  className="btn"><i className="icons"><Img
                                                    src={require("img/ico-addpage-lg.svg")} /></i>{t('GI_ADD_PAGE')}
                                                </button>
                                              </div>
                                            </div>
                                          )}
                                    ...
                                    {this.state.link && this.state.displayInner === item.id && (
                                      <div className="parctical-info-widgets">
                                        <Link
                                          datamode={this.state.childEditMode ? t('GI_EDIT_LINK') : t('GI_ADD_LINK')}
                                    ...
                                    {this.state.folder && this.state.displayInner === item.id && (
                                      <div className="parctical-info-widgets">
                                        <Folder
                                          datamode={this.state.childEditMode ? t('GI_EDIT_FOLDER') : t('GI_ADD_FOLDER')}
                                          onCancel={this.cancel}
                                          save={this.save}
                                          editData={this.state.editData}
                                          parent_id={this.state.parent_id}
                                    ...
                                    {this.state.page && this.state.displayInner === item.id && (
                                      <div className="parctical-info-widgets">
                                        <Page
                                          datamode={this.state.childEditMode ? t('GI_EDIT_PAGE') : t('GI_ADD_PAGE')}
                                          onCancel={this.cancel}
                                          save={this.save}
                                          editData={this.state.editData}
                                          parent_id={this.state.parent_id}
