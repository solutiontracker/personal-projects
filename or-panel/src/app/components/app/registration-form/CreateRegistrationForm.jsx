...
class CreateRegistrationForm extends React.Component {
  _isMounted = false;
  ...
  saveData = e => {
    ...
    RegistrationService.update(request_data, 'basic').then(
      response => {
        if (response.success) {
          this.setState({
            isLoader: false,
          ...
          if (type === "save-next") this.props.history.push('/event/registration/attendee-type-form');
        }
      },
      error => { }
    );
              ...
              {!this.state.preLoader && (
                <React.Fragment>
                  ...
                  <header style={{marginBottom: 0}} className="new-header clearfix">
                    <div className="row">
                      <div className="col-6">
                        <h1 className="section-title">{t('RF_ATTENDEE_FIELDS')}</h1>
                        <p>{t('RF_CUSTOMIZE_SIGNUP_FORM_SORTING_INFO')}</p>
                      </div>
                    </div>
                  </header>
                  <DragDropContext onDragEnd={this.onDragEnd} onDragStart={this.onDragStart.bind(this)}>
                    <div className="row d-flex">
                      <div style={{paddingRight: 0}} className="col-6">
                        {/* <h4 className="component-heading">{t('RF_CREATE_SIGNUP_REGISTRATION_FORM')}</h4> */}
                                ...
                                <Draggable
                                  ...
                                  {(provided, snapshot) => (
                                    <div
                                      ...
                                      <span className="list-drag material-icons">more_vert more_vert</span>
                                      ...
                                      <span data-index={index} onClick={this.removeItem.bind(this)}
                                        className="btn-remove-list">
                                        <i data-index={index} className="icons"><Img src={require('img/ico-bin-alt.svg')} alt="" /></i></span>
                                    </div>
                                  )}
                                </Draggable>
                              ))}
                      ...
                      <div className="col-6">
                        <div className="selection-item-wrapp">
                          ...
                          <div className="search-fields">
                            ...
                            <input onChange={this.searchList.bind(this)} type="text" placeholder={t('G_SEARCH')} />
                          </div>
                  ...
                  <div className="bottom-component-panel clearfix">
                    ...
                    <NavLink className="btn btn-prev-step" to="/event_site/billing-module/manage-orders"><span className="material-icons">
