...
i18n
    ...
    .init({
        resources,
        lng: (
            localStorage.getItem('interface_language_id') !== 'undefined' &&
            localStorage.getItem('interface_language_id') !== null
        ) ? _lang[localStorage.getItem('interface_language_id')-1] : 'en',
