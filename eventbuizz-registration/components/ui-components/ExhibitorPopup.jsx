                    ...
                    <div className="row d-flex">
                        ...
                        <div className="col-sm-8">
                            <div className="ebs-container-content">
                                ...
                                <p><ActiveLink href={data.url.replace(/^https?:\/\//, "") != "" ? data.url : `/${eventUrl}/exhibitors/${data.id}`}>{labels.EVENTSITE_READMORE ? labels.EVENTSITE_READMORE : 'Read more'}</ActiveLink></p>
                            </div>
                        </div>
                    </div>
                </div>
