...
const CreateQuestions = ({title}: any) => {
  const [modalVisible, setModalVisible] = useState(false);
  const [scheduleModal, setscheduleModal] = useState(false);
  const { createquestion, program_id } = UsePollsService();
          ...
          {<>
            ...
            <Modal.Body borderWidth="0">
              <Container w="100%" maxW="100%">
                ...
                <Box mb="2" px="4" py="2" rounded="20px" borderWidth="1" borderColor="#E0E0E0" w="100%">
                ...
                {(state.questiontype === 'single' || state.questiontype === 'multiple' || state.questiontype === 'dropdown') && <Single type={false} item_data={getData} />}
                {state.questiontype === 'matrix' && 
                  <>
                    <Single item_data={getData} type={false} />
                    <Single item_data={getColumn} type="column" />
                  </>
                }
            ...
            <Modal.Footer pt="0" borderColor={'transparent'}>
              <Button.Group size="md" space="2">
                ...
                <Button onPress={handleSubmit} rounded="20px" minW="100px" _text={{ fontWeight: 'bold' }}>
                Save
                </Button>
              </Button.Group>
            </Modal.Footer>
