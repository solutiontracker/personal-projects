...
class EventRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'cancellation_date' => ($this->request->get('cancellation_date') ? 'bail|required|date|not_in:0000-00-00 00:00:00|after_or_equal:today' : ''),
            'registration_end_date' => ($this->request->get('registration_end_date') ? 'bail|required|date|not_in:0000-00-00 00:00:00|after_or_equal:today' : ''),
