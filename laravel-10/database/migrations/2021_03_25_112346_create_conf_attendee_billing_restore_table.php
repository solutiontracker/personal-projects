...
class CreateConfAttendeeBillingRestoreTable extends Migration
{
    const TABLE = 'conf_attendee_billing_restore';
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        Schema::create(self::TABLE, function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->tinyInteger('processed')->default(0)->index('processed');
        });
