<?php
    ...
    class CreateConfAdditionalInfoPagesTable extends Migration
    {
        const TABLE = 'conf_additional_info_pages';
        ...
        public function up()
        {
            Schema::create(self::TABLE, function (Blueprint $table) {
                ...
                $table->tinyInteger('page_type')->index('page_type')->comment('1=cms page; 2=url');
