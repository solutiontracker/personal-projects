        ...
        <div class="pdf-page">
                ...
                <div class="pdf-header-left">
                    <ul>
                        ...
                        <li>
                            ...
                            <strong>{{ $ticket->type == 'billing' ? ucwords($event_setting['organizer_name']) : ucwords($ticket->addon->order->user->name) }}</strong>
                        </li>
                        <li>
            ...
            <div class="pdf-content">
                <div class="content-holder">
                    <div class="barcode">
                        <img src="{{ url('api/qr-code?chl=' . $ticket->qrString) }}" alt="">
                    </div>
                    <div class="pdf-content-left">
                        <div class="pdf-logo">
                            @if ($event_setting['header_logo'] && $event_setting['header_logo'] != 'NULL')
                                <img
                                    src="{{ config('app.eventcenter_url') . '/assets/event/branding/' . $event_settings['header_logo'] }}" />
                            @else
                                <img
                        ...
                        <div class="content-text">
                            <strong>{{ getEventName($ticket->event_id) }}</strong>
                        </div>
                    </div>
                </div>
                <div class="ticket-type">
                    <span>{{ $labels['TICKET_TYPE'] }}</span>
                    <strong>{{ $ticket->ticket_item->item_name }}</strong>
                </div>
                ...
                <div class="location-bar" style="background: {{ $event_setting['primary_color'] }};">
                    <strong>{{ $event_setting['location_name'] }}, <span>{{ $event_setting['location_address'] }},
                            {{ getCountryName($event_setting['country_id']) }}</span></strong>
                </div>
                <div class="pdf-footer">
                    <strong><span>{{ $labels['TICKETS_ORGANISED_BY'] }}:</span>
                        {{ ucwords($event_setting['organizer_name']) }}</strong>
                </div>
            </div>
