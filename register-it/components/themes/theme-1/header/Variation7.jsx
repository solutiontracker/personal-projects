...
class Variation7 extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={{ transform: 'none' }} id="ebs-header-master" className="ebs-main-header ebs-main-header-v1 ebs-main-header-v2 ebs-header-main-wrapper ebs-header-shadow ebs-main-light-header ebs-header-shadow ebs-main-light-header">
          ...
          <div className="row d-flex align-items-center">
            ...
            <div id="ebs-header-wrapper" className="col-lg-9 col-6 d-flex align-items-center justify-content-end">
              {parseInt(event.eventsiteSettings.eventsite_menu) === 1 && <nav className="navbar navbar-expand-lg navbar-light">
                  ...
                  >
                    {!this.state.showMenu ? <span className="navbar-toggler-icon"></span> : <span style={{fontSize: 34, marginTop: 4, height: 30}} className="material-icons">close</span>}
                  </button>
                        ...
                        {menu.alias === "custom" ? (
                          menu.url !== "" ? (
                            ...
                            <ActiveLink
                              ...
                              aria-current="page"
                              href={`/${this.props.event.url}/${menu.alias}/${menu.page_id}`}
                            >
                              {menu.module}
                            </ActiveLink>
                          )
