import { header, handleResponse } from '@/src/app/helpers';

export const service = {
    get, put, post, _import, destroy, download, downloadWithPost, simplePost
};
...
function simplePost(url, request_data){
    const requestOptions = {
        method: "POST",
